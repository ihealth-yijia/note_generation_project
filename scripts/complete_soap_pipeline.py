...
class CompleteSoapPipeline:
    ...
    def process_single_transcript(self, file_path: Path, detail_level: str = "standard",
        ...
        try:
            ...
            self.logger.info(f"Processing {transcript_id}: Stage 3 - Formatting styled SOAP note")
...
def main():
    ...
    pipeline.process_single_file_demo(single_file, "standard", "bullet_point")

    # Option 2: Process all transcripts
    '''results_df = pipeline.process_all_transcripts(
